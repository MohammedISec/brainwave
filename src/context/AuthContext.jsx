...
const LOGOUT_URL = "http://localhost:8001/logout";
...
export const AuthProvider = ({ children }) => {
  ...
  const loginRedirect = () => {
    const url = `${SSO_LOGIN_URL}?client_id=${CLIENT_ID}&redirect_uri=${encodeURIComponent(REDIRECT_URI)}`;
  ...
  return (
    <AuthContext.Provider
      value={{ user, loading, loginRedirect, exchangeCode, fetchProfile, logout }}
    >
      {children}
    </AuthContext.Provider>
  );
